...
import { SleeperWeeklyStats } from "./sleeper-stats.js";
import { SleeperWeeklyProjections } from "./sleeper-projections.js";
...
const service = new DashboardService({ store: new SnapshotStore(directory, leagueId), leagueId, playerDirectory, draftBoard, nflScoreboard: new NflScoreboard(), espnFantasy: new EspnFantasyProjections(), sleeperStats: new SleeperWeeklyStats(), sleeperProjections: new SleeperWeeklyProjections() });
